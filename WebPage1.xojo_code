...
Begin WebPage WebPage1
   ...
   Begin WebLabel Label1
      ...
      Scope           =   2
      TabIndex        =   1
      Text            =   "This is an example of a custom listbox cell containing two buttons. Clicking either of the buttons will trigger the CustomCellAction event on the Listbox so you can tell which button was clicked and in which row and column."
      TextAlignment   =   0
      TextColor       =   &c00000000
      Tooltip         =   ""
      Top             =   20
